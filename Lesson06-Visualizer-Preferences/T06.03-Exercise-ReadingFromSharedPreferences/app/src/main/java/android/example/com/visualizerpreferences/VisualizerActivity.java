...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TODO (COMPLETE) (1) Change the name of default setup to setupSharedPreferences
    private void setupSharedPreferences() {
        // TODO (COMPLETE) (2) Get a reference to the default shared preferences from the PreferenceManager class
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        // TODO (COMPLETE) (3) Get the value of the show_bass checkbox preference and use it to call setShowBass
