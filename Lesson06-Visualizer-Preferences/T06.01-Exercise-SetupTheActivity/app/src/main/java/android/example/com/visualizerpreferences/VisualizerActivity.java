...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TODO (COMPLETE)  (1) Create a new Empty Activity named SettingsActivity; make sure to generate the
    // activity_settings.xml layout file as well and add the activity to the manifest

    // TODO (COMPLETE) (2) Add a new resource folder called menu and create visualizer_menu.xml
    // TODO (COMPLETE) (3) In visualizer_menu.xml create a menu item with a single item. The id should be
    ...
    // TODO (COMPLETE) (5) Add the menu to the menu bar
    @Override
    ...
    // TODO (COMPLETE) (6) When the "Settings" menu item is pressed, open SettingsActivity
    @Override
