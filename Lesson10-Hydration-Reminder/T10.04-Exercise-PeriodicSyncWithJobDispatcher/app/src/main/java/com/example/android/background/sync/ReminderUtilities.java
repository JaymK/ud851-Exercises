...
public class ReminderUtilities {
    ...
    // TODO (COMPLETE) (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context) {
        // TODO (COMPLETE) (17) If the job has already been initialized, return
        if (sInitialized) return;
        // TODO (COMPLETE) (18) Create a new GooglePlayDriver
        Driver driver = new GooglePlayDriver(context);
        // TODO (COMPLETE) (19) Create a new FirebaseJobDispatcher with the driver
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(driver);

        // TODO (COMPLETE) (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // TODO (COMPLETE) (21) Use dispatcher's schedule method to schedule the job
        dispatcher.schedule(constraintReminderJob);
        // TODO (COMPLETE) (22) Set sInitialized to true to mark that we're done setting up the job
        sInitialized = true;
    }
