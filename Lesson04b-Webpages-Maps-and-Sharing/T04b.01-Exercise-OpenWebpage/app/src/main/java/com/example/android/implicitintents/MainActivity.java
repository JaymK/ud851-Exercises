...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // TODO (COMPLETE) (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )
        String urlAsString = "https://www.udacity.com";

        // TODO (COMPLETE) (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
    ...
    // TODO (COMPLETE) (1) Create a method called openWebPage that accepts a String as a parameter
    private void openWebPage(String url) {

        // Do steps 2 - 4 within openWebPage

        // TODO (COMPLETE) (2) Use Uri.parse to parse the String into a Uri
        Uri webpage = Uri.parse(url);
        // TODO (COMPLETE) (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
