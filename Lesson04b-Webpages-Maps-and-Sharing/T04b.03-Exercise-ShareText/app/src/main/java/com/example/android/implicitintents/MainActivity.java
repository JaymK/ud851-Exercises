...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // TODO (COMPLETE) (5) Specify a String you'd like to share
        String textThatYouWantToShare =
                "Hi! Sharing tha' coolest thing I've learned so far. You should " +
                        "check out Udacity and Google's Android Nanodegree!";

        // TODO (COMPLETE) (6) Replace the Toast with shareText, passing in the String from step 5
    ...
    // TODO (COMPLETE) (1) Create a void method called shareText that accepts a String as a parameter
    private void shareText(String textToShare) {

    // Do steps 2 - 4 within the shareText method

        // TODO (COMPLETE) (2) Create a String variable called mimeType and set it to "text/plain"
        String mimeType = "text/plain";

        // TODO (COMPLETE) (3) Create a title for the chooser window that will pop up
        String title = "Learning How to Share";

        // TODO (COMPLETE) (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
