...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        // TODO (COMPLETE) (5) Store an address in a String
        String addressString = "1600 Ampitheatre Parkway, CA";

        // TODO (COMPLETE) (6) Use Uri.Builder with the appropriate scheme and query to form the Uri for the address
        ...
        // TODO (COMPLETE) (7) Replace the Toast with a call to showMap, passing in the Uri from the previous step
        showMap(addressUri);
    }
    ...
    // TODO (COMPLETE) (1) Create a method called showMap with a Uri as the single parameter
    private void showMap(Uri geoLocation) {


    // Do steps 2 - 4 within the showMap method
        // TODO (COMPLETE) (2) Create an Intent with action type, Intent.ACTION_VIEW
        Intent intent = new Intent(Intent.ACTION_VIEW);

        // TODO (COMPLETE) (3) Set the data of the Intent to the Uri passed into this method
        intent.setData(geoLocation);

        // TODO (COMPLETE) (4) Verify that this Intent can be launched and then call startActivity
        if (intent.resolveActivity(getPackageManager()) != null) {
            startActivity(intent);
        }
    }
