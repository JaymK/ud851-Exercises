    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO (COMPLETE) (1) Store ChildActivity.class in a Class object called destinationActivity
                Class destinationActivity = ChildActivity.class;


                // TODO (COMPLETE) (2) Create an Intent to start ChildActivity
                Intent startChildActivityIntent = new Intent(context, destinationActivity);

                // TODO (COMPLETE) (3) Replace the Toast with code to start ChildActivity
